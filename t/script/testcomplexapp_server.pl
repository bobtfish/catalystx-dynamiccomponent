...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TESTCOMPLEXAPP_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TESTCOMPLEXAPP_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
testcomplexapp_server.pl - Catalyst Testserver

=head1 SYNOPSIS

testcomplexapp_server.pl [options]
